...
class Tesoro:
    ...
    Atributos:
        beneficio (list): Lista de tipos de beneficios que puede otorgar el tesoro.
    """

    def __init__(self):
        """Inicializa un nuevo tesoro con tipos de beneficios predefinidos."""
        self.beneficio = ["aumento de ataque", "aumento de defensa", "restauración de salud"]
    ...
    def encontrar_tesoro(self, heroe):
        ...
        """
        beneficio_nombre = random.choice(self.beneficio)  # Selección aleatoria de un beneficio
        beneficio_valor = random.randint(1, 5)  # Valor del beneficio entre 1 y 5
        ...
        if beneficio_nombre == self.beneficio[0]:  # Aumento de ataque
            ...
            print(f"La defensa de {heroe.nombre} aumenta en {beneficio_valor}.")
